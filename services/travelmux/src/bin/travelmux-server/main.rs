...
async fn main() -> Result<()> {
    ...
    HttpServer::new(move || {
        ...
        App::new()
            ...
            .service(api::v8::plan::get_plan)
            .service(api::v8::directions::get_directions)
            .service(api::v8::elevation::get_elevation)
            .service(api::v8::vehicle_positions::post_vehicle_positions)
