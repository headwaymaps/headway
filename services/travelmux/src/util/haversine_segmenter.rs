use geo::{
    algorithm::{Distance, Haversine, InterpolatePoint},
...
mod test {
    ...
    use geo::{coord, Haversine, Length};
    ...
    fn test_happy_path() {
        ...
        let east_of_berlin = coord!(x: 13.482210264987543, y: 52.346405263573146);
    ...
    fn degenerate_empty_line_string() {
        ...
        assert_eq!(0.0, Haversine.length(&empty));
